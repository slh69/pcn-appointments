<template>
    <div class="flex h-screen w-2/3 mx-auto">
        <div class="bg-gray-100 w-1/3 overflow-y-auto m-4">
            ...
            <div class="border-gray-600 p-6 my-6 mr-3 ml-2 rounded-l shadow-md mx-auto bg-white">
                <h4 class="text-sm font-bold">Welcome to pureCHIROnow</h4>
                <p class="text-xs color-gray-200">We are looking forward to seeing you soon! Our office is closed July
                    4.</p>
            </div>
            ...
            <div class="flex justify-evenly pb-4 gap-2 mx-2">
                <ul role="list" class="w-1/3">
                    <li class="bg-gray-200 text-center rounded-lg ">
                        <div class="p-2">
                            <img class="mx-auto h-20 w-20 rounded-full " src="../assets/doc.jpg" alt="" />
                            <div class="space-y-2">
                                <div class="font-medium text-md pt-3">
                                    <h3 class="text-gray-600 place ">Dwayne Hoskins</h3>
                                    <p class="text-gray-500">Gentle Giant</p>
                                </div>
                            </div>
                        </div>
                    </li>
                ...
                <ul role="list" class="w-1/3">
                    <li class="bg-gray-200 text-center rounded-lg ">
                        <div class="p-2">
                            <img class="mx-auto h-20 w-20 rounded-full " src="../assets/sam.jpg" alt="" />
                            <div class="space-y-2">
                                <div class="font-medium text-md pt-3">
                                    <h3 class="text-gray-600 place ">Sam Ralls</h3>
                                    <p class="text-gray-500">Chiropractor</p>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <div ref="container" class="flex flex-auto flex-col overflow-y-auto ">
                        <div ref="containerNav"
                            ...
                            <button type="button" class="flex flex-col items-center pt-3 pb-1.5">
                                <span>T</span>
                                <span
                                    class="mt-3 flex h-8 w-8 items-center justify-center rounded-full text-base font-semibold text-indigo-600">20</span>
                            </button>
                            <button type="button" class="flex flex-col items-center pt-3 pb-1.5">
                                <span>F</span>
                                <span
                                ...
                                <ol class="col-start-1 col-end-2 row-start-1 grid grid-cols-1"
                                    ...
                                    <li class="relative mt-px flex" style="grid-row: 134 / span 18">
                                        <a href="#"
                                            ...
                                            <p class="order-1 text-indigo-500 group-hover:text-indigo-700">Eiffel Tower
                                            </p>
    ...
    <div class="bg-slate-600 w-full flex justify-between p-10">
        ...
        <h1 class="text-white">125 Donut Way, Inman SC 55555</h1>
    </div>
</template>
